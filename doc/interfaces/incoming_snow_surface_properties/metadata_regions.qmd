...
display_jsonschema_markdown("superRegionsIndex")
```
</details>
...
```{python}
#| echo: false
display_jsonschema_markdown("subRegionsIndex")
```
</details>
...
```{python}
#| echo: false
display_jsonschema_markdown("subRegionCollectionsIndex")
```
</details>
...
```{python}
#| echo: false
display_jsonschema_markdown("subRegionsHierarchy")
```
</details>
